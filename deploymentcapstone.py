...
test_image_path = 'bjorke_1.png'
data = np.ndarray(shape=(1, 224, 224, 3), dtype=np.float32)

#initialize GUI
top=tk.Tk()
top.geometry('800x600')
top.title('COVID-19 CT Scan Image Classification')
...
heading = Label(top, text="COVID-19 CT Scan Image Classifier",pady=20, font=('arial',20,'bold'))
